function [f,lwrCross,uprCross,lwrRef,uprRef,stateLevs] = falltimeState(x, varargin)
...
[f,lwrCross,uprCross,lwrRef,uprRef, stateLevs] = transdursState(x,-1,plotFlag,inpArgs{:});
