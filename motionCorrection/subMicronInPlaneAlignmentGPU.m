function [registeredImage,  output] = subMicronInPlaneAlignmentGPU(referenceImage,sourceImage,filterParameters,skipReferenceImage,shiftInDiscreteValues)
...
% Modifed by Michael Savage 02/21/2019 to allow for GPU ultisation
...
% refImage = gpuArray(refImage);
% srcImage = gpuArray(srcImage);
...
paddedImage = gpuArray(zeros(paddingInfo.ext));  
