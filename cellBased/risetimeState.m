function [r,lwrCross,uprCross,lwrRef,uprRef, stateLevs] = risetime(x, varargin)
...
[r,lwrCross,uprCross,lwrRef,uprRef, stateLevs] = transdursState(x,1,plotFlag,inpArgs{:});
